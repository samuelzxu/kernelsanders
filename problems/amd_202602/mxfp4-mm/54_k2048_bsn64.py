"""
MXFP4-MM: Try BSN=64/BSK=512/3stages for K=2048/M=64.
Also try BSN=32/BSK=512/stages=3 for K=1536/M=256 without split-K.
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # EXPERIMENT: BSM=32, BSN=64, BSK=512, 3 stages for K=2048
    "N=7168-K=2048": {
    ...
    # EXPERIMENT: BSM=32, BSN=32, BSK=512, 3 stages, KSPLIT=1 for K=1536
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 2, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 3, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 128, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 128, "GROUP_SIZE_M": 16, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 32, "cache_modifier": None}
    },
}
