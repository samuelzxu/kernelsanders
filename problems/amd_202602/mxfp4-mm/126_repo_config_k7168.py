"""
MXFP4-MM: #126 - Use repo's original tuned config for N=2112-K=7168.
Our override: BSN=64 KSPLIT=8(→7) num_stages=3 = 231 tiles (0.9 waves)
Repo's config: BSN=32 KSPLIT=14 num_stages=2 = 924 tiles (3.6 waves)
The repo config was tuned by AMD for MI355X. It has 4x more tiles.
Don't inject N=2112-K=7168 config → falls through to repo's tuned config.
"""
import json
import os
import triton
...
# NOTE: Removed N=2112-K=7168 from injection → repo config used
_CONFIGS = {
    "N=2880-K=512": {
    ...
    # N=2112-K=7168: NOT injected - repo's tuned config used (BSN=32 KSPLIT=14)
    "N=7168-K=2048": {
