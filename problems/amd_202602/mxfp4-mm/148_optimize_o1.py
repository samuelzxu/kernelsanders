"""
MXFP4-MM: #148 - LLVM OPTIMIZE_O1.
O2=O3=Os all produce identical code. O1 is significantly less aggressive
and might skip register-hungry passes (LSR, LICM, loop unrolling).
O0 was 2x slower (no optimization at all). O1 might be the sweet spot.
"""
...
def _patch_to_o1():
    try:
        ...
        if 'llvm.OPTIMIZE_O3' in content:
            ...
            print("[PATCH] Changed LLVM opt O3->O1", file=sys.stderr)
