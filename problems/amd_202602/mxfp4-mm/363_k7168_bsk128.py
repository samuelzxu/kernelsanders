...
#!POPCORN gpu MI355X
"""
#363: K=7168 BSK=128 KSPLIT=8 — smaller K-blocks, more K-iterations.
Each split: K_packed/KSPLIT = 3584/7 = 512. BSK=128: 4 iters per split.
This doubles the K-loop iterations but uses half the registers per iteration.
"""
