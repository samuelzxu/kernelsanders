"""
MXFP4-MM: #138 - LLVM_ARGS env var to disable LSR+LICM.
LLVM itself reads LLVM_ARGS for command-line flags. This bypasses Triton's
Python layer and goes directly to the LLVM library linked into libtriton.so.
Combined with cache clear to force recompilation.
"""
import os, shutil
# LLVM reads this env var directly for command-line flags
os.environ['LLVM_ARGS'] = '-disable-lsr -disable-machine-licm'
# Also try AMD-specific LLVM args
os.environ['AMD_COMGR_ACTION_OPTIONS'] = '-disable-lsr -disable-machine-licm'
