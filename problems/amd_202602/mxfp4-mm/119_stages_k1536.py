"""
MXFP4-MM: #119 - Try num_stages=2 for K=1536 (3 K-iters after get_splitk).
With 3 iterations and num_stages=3 (current): prologue dominates.
With num_stages=2: more steady-state iterations, better overlap.
Also keep num_stages=4 for K=2048 (confirmed improvement in #118).
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # KEY CHANGE: num_stages=2 for K=1536 (3 K-iters, was 3)
    "N=3072-K=1536": {
