...
#!POPCORN gpu MI355X
"""
#361: Try HIP/ROCm environment variables to reduce dispatch overhead.
AMD_DIRECT_DISPATCH=1 bypasses the software scheduler.
HIP_FORCE_DEV_KERNARG=1 uses device-side kernel arguments (lower latency).
"""
import os
