...
#!POPCORN gpu MI355X
"""
#398: Test set_use_gemm_splitk_bf16 — use bf16 intermediate for split-K.
This halves the memory traffic for the reduce kernel!
"""
import torch, os, json
from task import input_t, output_t

# SET SPLITK BF16 BEFORE IMPORTING THE KERNEL
import aiter.ops.triton.gemm.basic.gemm_afp4wfp4 as afmod
if hasattr(afmod, 'set_use_gemm_splitk_bf16'):
    afmod.set_use_gemm_splitk_bf16(True)
    print("set_use_gemm_splitk_bf16(True) called!")
else:
    print("set_use_gemm_splitk_bf16 not found in afmod")

# Also check: is it a module-level function?
import aiter.ops.triton.gemm.basic.gemm_a16wfp4 as wmod
if hasattr(wmod, 'set_use_gemm_splitk_bf16'):
    wmod.set_use_gemm_splitk_bf16(True)
    print("set on wmod too!")
