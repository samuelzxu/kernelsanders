...
#!POPCORN gpu MI355X
"""
#297: K=1536 M=256: BSN=64 KSPLIT=1 (384 blocks, no reduction kernel).
Current: BSN=256 KSPLIT=3 at 19.3µs. Split-K reduction is the bottleneck.
Grid: (256/32) × (3072/64) × 1 = 8 × 48 × 1 = 384 blocks (1.26 waves on 304 CUs)
Each block does 3 K-iterations inline (K_packed/BSK = 768/256 = 3)
"""
...
_cfgs = {
    ...
    # K=1536 M=256: BSN=64 KSPLIT=1 → 384 blocks, no reduction kernel!
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 8, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None}
    },
}
