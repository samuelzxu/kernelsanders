...
#!POPCORN gpu MI355X
"""
#364: K=7168 BSK=512 KSPLIT=7 (3584/7=512, BSK=512: 1 iter per split, no masking).
Previously tried with BSK=512 KSPLIT=7 → 17.5µs (worse). But now with all other
shapes optimized, let me try BSK=512 KSPLIT=8 (get_splitk adjusts to 7).
Also try stages=3 with BSK=512.
"""
