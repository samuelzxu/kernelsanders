"""
MXFP4-MM: #131 - Disable LSR+LICM with space-separated flags + cache clear.
#130 proved DISABLE_LLVM_OPT works (disabling ALL = 2x slower).
#128-129 used comma format which wasn't parsed. Try space-separated.
"""
import os, shutil
# Space-separated LLVM flags
