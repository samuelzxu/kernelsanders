...
#!POPCORN gpu MI355X
"""
#353: K=7168 M=16 BSN=32 KSPLIT=8 (528 blocks). Much more parallelism.
BUT: for K=7168 quant amortization matters more since K_packed=3584 is large.
"""
...
"N=2112-K=7168":{
"M_LEQ_16":{"BLOCK_SIZE_M":16,"BLOCK_SIZE_N":32,"BLOCK_SIZE_K":256,"GROUP_SIZE_M":1,"NUM_KSPLIT":8,"num_warps":4,"num_stages":2,"waves_per_eu":4,"matrix_instr_nonkdim":16,"cache_modifier":".cg"},
