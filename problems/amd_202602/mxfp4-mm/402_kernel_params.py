...
#!POPCORN gpu MI355X
"""
#402: Extract the FULL kernel function signature to find hidden parameters.
"""
import torch, os, json, inspect, sys
...
try:
    ...
    # Print just the function signature (first 30 lines)
    lines = src.split('\n')
