"""
MXFP4-MM: #117 - num_stages=4 for K=2048 M=64 shape.
K=2048/BSK=512 → 4 K iterations. A 4-stage pipeline could overlap all loads
with compute. Currently using num_stages=2 (2-stage pipeline).
Also try num_stages=4 for K=7168 (7 K iterations with get_splitk KSPLIT=7).
Based on #102.
"""
import json
import os
...
_CONFIGS = {
    ...
    # K=7168: Try num_stages=4 (7 K-iters after get_splitk, was 3)
    "N=2112-K=7168": {
        "M_LEQ_16": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 8, "num_warps": 4, "num_stages": 4, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
    ...
    # K=2048: Try num_stages=4 (4 K-iters, was 2)
    "N=7168-K=2048": {
