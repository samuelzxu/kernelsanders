...
#!POPCORN gpu MI355X
"""
#444: Try torch.jit.trace on the custom_kernel function to reduce Python dispatch.
JIT-traced functions have lower overhead than Python functions.
"""
...
# Try torch.compile on the hot path
_ck=None;_cw=None;_cs=None
_fn = gemm_a16wfp4_preshuffle  # cache the function reference
...
def custom_kernel(data: input_t) -> output_t:
    ...
    return _fn(A,_cw,_cs,True,torch.bfloat16)  # positional args, cached fn ref
