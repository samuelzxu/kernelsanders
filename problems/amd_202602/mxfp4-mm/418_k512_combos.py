...
#!POPCORN gpu MI355X
"""
#418: K=512 M=4: BSN=16 waves=3 stages=2. K=512 M=32: BSN=32 waves=3.
Try non-standard wave counts for small shapes.
Also: M=4 BSN=32 waves=1 (bigger tiles, minimum occupancy)
"""
...
_cfgs={"N=2880-K=512":{
"M_LEQ_4":{"BLOCK_SIZE_M":8,"BLOCK_SIZE_N":32,"BLOCK_SIZE_K":512,"GROUP_SIZE_M":1,"NUM_KSPLIT":1,"num_warps":4,"num_stages":1,"waves_per_eu":1,"matrix_instr_nonkdim":16,"cache_modifier":".cg"},
