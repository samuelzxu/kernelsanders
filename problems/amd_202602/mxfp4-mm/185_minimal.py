"""
MXFP4-MM: #185 - Absolute minimal implementation to establish true baseline.

No fused kernel, no caching, no O1 patch, no config injection.
Just: dynamic_mxfp4_quant(A) + gemm_afp4wfp4(A_q, B_q, A_scale, B_scale)
with B_scale from e8m0_unshuffle.

This tells us the RAW Triton path performance without any of our optimizations.
"""
import torch
