"""
MXFP4-MM: #128 - Disable LLVM LSR and Machine LICM passes.
Inspired by leaderboard: 'disable_lsr_disable_machine_licm' at 9.7µs!
LLVM's Loop Strength Reduction and Machine LICM increase register pressure
for FP4 GEMM kernels, causing register spills. Disabling them via
DISABLE_LLVM_OPT environment variable improves register utilization.
"""
import os
# MUST be set before any Triton import to affect JIT compilation
