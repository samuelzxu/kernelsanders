"""
MXFP4-MM: #122 - waves_per_eu=0 + GROUP_SIZE_M=1 for K=2048.
waves_per_eu=0 lets compiler auto-select occupancy (vs hardcoded 1).
GROUP_SIZE_M=1 uses simple row-major tile ordering (vs grouped=2).
With num_stages=4, the compiler may choose different occupancy.
Also try waves_per_eu=0 for K=1536 M=256 (currently 2).
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # KEY: waves_per_eu=0 + GROUP_SIZE_M=1 with num_stages=4
    "N=7168-K=2048": {
        "M_LEQ_64": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 4, "waves_per_eu": 0, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
    ...
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 2, "NUM_KSPLIT": 2, "num_warps": 4, "num_stages": 3, "waves_per_eu": 0, "matrix_instr_nonkdim": 32, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 128, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 128, "GROUP_SIZE_M": 16, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 32, "cache_modifier": None}
    },
}
