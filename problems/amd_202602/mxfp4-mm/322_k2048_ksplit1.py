...
#!POPCORN gpu MI355X
"""
#322: Try K=2048 KSPLIT=1 mfma32 BSN=256 (no reduction, 4 K-iters per block).
Current: KSPLIT=2 mfma32 at 13.6µs. Grid: 4×28×2=224.
KSPLIT=1: Grid: 4×28=112. Fewer blocks but no reduction.
K_packed=1024, BSK=256: 4 iters. BSK=512: 2 iters.
"""
...
_cfgs = {
    ...
    # K=2048: KSPLIT=1 mfma32 BSN=256 BSK=512 (2 iters, 112 blocks)
    "N=7168-K=2048": {
        "M_LEQ_64": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 32, "cache_modifier": ".cg"},
