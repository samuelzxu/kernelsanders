...
#!POPCORN gpu MI355X
"""
#413: K=1536 mfma16 waves=3 KSPLIT=2 BSN=128.
BSN=128 gives more blocks (8*24*2=384) vs BSN=256 (8*12*2=192).
With waves=3 and mfma16, smaller tiles might work better.
"""
...
"M_LEQ_256":{"BLOCK_SIZE_M":32,"BLOCK_SIZE_N":128,"BLOCK_SIZE_K":256,"GROUP_SIZE_M":4,"NUM_KSPLIT":2,"num_warps":4,"num_stages":2,"waves_per_eu":3,"matrix_instr_nonkdim":16,"cache_modifier":".cg"},
