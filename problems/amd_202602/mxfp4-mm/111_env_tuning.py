"""
MXFP4-MM: #111 - ROCm environment variable tuning.
HIP_FORCE_DEV_KERNARG=1: Forces device kernel arguments → faster kernel launch.
GPU_MAX_HW_QUEUES=2: Limit HW queues to reduce context switching.
Based on #102 (current best).
"""
import os
# Set BEFORE any HIP/ROCm imports
