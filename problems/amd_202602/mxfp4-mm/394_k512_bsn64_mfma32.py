...
#!POPCORN gpu MI355X
"""
#394: K=512 M=32 BSN=64 mfma32 warps=4.
BSN=64/mfma32=2 tiles. Current BSN=32 mfma16 at 8.5µs.
Also try M=4 BSN=32 mfma32 (but BSM=8<32 so mfma32 won't work for M=4).
"""
...
"M_LEQ_32":{"BLOCK_SIZE_M":32,"BLOCK_SIZE_N":64,"BLOCK_SIZE_K":512,"GROUP_SIZE_M":1,"NUM_KSPLIT":1,"num_warps":4,"num_stages":1,"waves_per_eu":2,"matrix_instr_nonkdim":32,"cache_modifier":".cg"},
