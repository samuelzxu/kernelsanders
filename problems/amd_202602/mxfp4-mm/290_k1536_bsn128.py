...
#!POPCORN gpu MI355X
"""
#290: K=1536 M=256: try BSN=128 KSPLIT=3 (576 blocks vs 288).
Also try BSM=16 for M_LEQ_256.
"""
...
_cfgs = {
    ...
    # K=1536 M=256: BSN=128 KSPLIT=3 → Grid: 8×24×3=576 blocks (vs 288 with BSN=256)
    # K_packed=768, KSPLIT=3: 256 per split, BSK=256: 1 iter per block
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 3, "num_warps": 4, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None}
    },
}
