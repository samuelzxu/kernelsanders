"""
MXFP4-MM: Tune K=2048/M=64 and K=1536/M=256 configs.
Try split-K for these shapes (the K=7168 breakthrough was from split-K tuning).
For M=64,K=2048: try KSPLIT=2 or 4 to parallelize across K
For M=256,K=1536: try KSPLIT=2 or different BSN
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # EXPERIMENT: M=64, N=7168, K=2048 - try split-K=2 with smaller tiles
    "N=7168-K=2048": {
    ...
    # EXPERIMENT: M=256, N=3072, K=1536 - try split-K=2
    "N=3072-K=1536": {
