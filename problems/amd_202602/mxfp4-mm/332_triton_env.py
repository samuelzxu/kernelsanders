...
#!POPCORN gpu MI355X
"""
#332: Test Triton environment variables for better codegen.
Try TRITON_DEFAULT_FP_FUSION=1 for fused multiply-add.
Also try clearing Triton cache to force recompilation.
"""
import os
# Set Triton optimization hints BEFORE importing triton
os.environ["TRITON_DEFAULT_FP_FUSION"] = "1"
os.environ["MLIR_ENABLE_TIMING"] = "0"  # don't slow down with timing
...
# Clear Triton cache to force fresh compilation with new env vars
import shutil, glob
for d in glob.glob("/home/runner/.triton/cache/*"):
    try: shutil.rmtree(d)
    except: pass
