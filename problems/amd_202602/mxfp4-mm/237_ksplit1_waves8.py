...
#!POPCORN gpu MI355X
"""
MXFP4-MM #237: KSPLIT=1 + waves_per_eu=8 for K=1536 M=256.
No split-K atomics. Under-subscribed (96 blocks for 304 CUs) but no reduction overhead.
waves_per_eu=8 encourages hardware to overlap wavefronts for latency hiding.
Also try GROUP_SIZE_M=8 for better L2 locality.
"""
...
_CONFIGS = {
    ...
    # K=1536: KSPLIT=1 + high waves for latency hiding + GROUP_SIZE_M=8
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 8, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 8, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
