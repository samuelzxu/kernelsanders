"""
MXFP4-MM: Debug - print cu_num and padded_m values to understand CK config lookup.
Uses #53 as the actual kernel, just adds diagnostic logging.
"""
import json
import os
import sys
...
# Debug: print cu_num and padded_m
try:
    from aiter.jit.utils.chip_info import get_cu_num
    from aiter.ops.gemm_op_common import get_padded_m
    cu = get_cu_num()
    print(f"[DEBUG] cu_num={cu}", file=sys.stderr)
    for m, n, k in [(4, 2880, 512), (16, 2112, 7168), (32, 4096, 512), (32, 2880, 512), (64, 7168, 2048), (256, 3072, 1536)]:
        ...
        print(f"[DEBUG] M={m},N={n},K={k}: padded_m(gl=0)={pm0}, padded_m(gl=1)={pm1}", file=sys.stderr)
    # Also check test shapes
    for m, n, k in [(8, 2112, 7168), (16, 3072, 1536), (64, 3072, 1536), (256, 2880, 512)]:
        pm0 = get_padded_m(m, n, k, 0)
        pm1 = get_padded_m(m, n, k, 1)
        print(f"[DEBUG] TEST M={m},N={n},K={k}: padded_m(gl=0)={pm0}, padded_m(gl=1)={pm1}", file=sys.stderr)
