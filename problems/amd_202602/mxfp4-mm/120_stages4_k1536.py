"""
MXFP4-MM: #120 - num_stages=4 for K=1536 too.
#118 showed num_stages=4 helps K=2048 (4 iters). K=1536 has 3 iters.
With num_stages=4, all 3 iterations' data is fully prefetched.
#119 showed num_stages=2 was worse. Try 4 (more aggressive prefetch).
Also keep num_stages=4 for K=2048.
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # KEY CHANGE: num_stages=4 for K=1536 (3 K-iters, was 3)
    "N=3072-K=1536": {
        "M_LEQ_64": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 2, "num_warps": 4, "num_stages": 4, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        "M_LEQ_256": {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 2, "NUM_KSPLIT": 2, "num_warps": 4, "num_stages": 4, "waves_per_eu": 2, "matrix_instr_nonkdim": 32, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 128, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 128, "GROUP_SIZE_M": 16, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 32, "cache_modifier": None}
    },
}
