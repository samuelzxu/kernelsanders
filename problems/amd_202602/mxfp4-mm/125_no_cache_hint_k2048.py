"""
MXFP4-MM: #125 - cache_modifier=None for K=2048 M=64.
With num_stages=4 already prefetching aggressively, the ".cg" hint might
cause L2 to retain stale B data from previous iterations (ranked benchmark).
Removing the hint lets L2 manage cache eviction naturally.
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # KEY: cache_modifier=None with num_stages=4
    "N=7168-K=2048": {
        "M_LEQ_64": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 2, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 4, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": None},
