"""
MXFP4-MM: #140 - Disable Triton debug line info + try knobs.
Debug line info adds instructions and uses registers.
Also try TRITON_ALWAYS_COMPILE=1 to force fresh compilation.
"""
import os, shutil
# Triton compilation knobs
os.environ['TRITON_DISABLE_LINE_INFO'] = '1'
os.environ['MLIR_ENABLE_REMARK_ALL'] = '0'
# Force recompilation
