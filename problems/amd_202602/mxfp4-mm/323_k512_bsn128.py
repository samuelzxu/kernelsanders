...
#!POPCORN gpu MI355X
"""
#323: K=512 M=32: try BSN=128 (vs current BSN=64).
N=2880: 23 blocks vs 45.  N=4096: 32 blocks vs 64.
BSN=128 has 2x better quant amortization but fewer blocks.
Also try mfma32 BSN=256 for K=512 M=32.
"""
...
_cfgs = {
    "N=2880-K=512": {"M_LEQ_4": {"BLOCK_SIZE_M": 8, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 1, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        # K=512 M=32: try BSN=128 mfma16
        "M_LEQ_32": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 1, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
