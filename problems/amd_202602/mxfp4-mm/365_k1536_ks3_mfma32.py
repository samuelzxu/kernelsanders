...
#!POPCORN gpu MI355X
"""
#365: K=1536 KSPLIT=3 mfma32 BSN=256. Previously tested KSPLIT=2 mfma32 (16.5µs)
and KSPLIT=3 mfma16 (19.3µs). KSPLIT=3 mfma32 is untested!
Also try KSPLIT=2 mfma32 with cache_modifier=None (currently .cg).
"""
