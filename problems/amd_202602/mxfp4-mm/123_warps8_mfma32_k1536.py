"""
MXFP4-MM: #123 - num_warps=8 for K=1536 M=256 with MFMA32.
BSM=64 BSN=64 with matrix_instr_nonkdim=32 creates 2x2 MFMA tiles.
8 warps (512 threads) can better utilize the 32x32 MFMA issue width.
Based on #118 (num_stages=4 for K=2048).
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # KEY: num_warps=8 for M=256 with MFMA32
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 2, "NUM_KSPLIT": 2, "num_warps": 8, "num_stages": 3, "waves_per_eu": 2, "matrix_instr_nonkdim": 32, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 128, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 128, "GROUP_SIZE_M": 16, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 32, "cache_modifier": None}
    },
}
