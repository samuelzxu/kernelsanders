"""
MXFP4-MM: #103 - MFMA 32x32 for M=64 (K=2048) and M=256 (K=1536).
#102 showed M=256 improved 1.1µs with MFMA32. M=64 also improved (20.0µs)
even without the MFMA32 change, suggesting #101's M=64 regression was noise.
Try MFMA32 for both large-M shapes. Keep MFMA16 for M<=32.
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # K=2048: Try MFMA 32 for M_LEQ_64
    "N=7168-K=2048": {
    ...
    # K=1536: MFMA 32 for M=256 (confirmed -1.1µs in #102)
    "N=3072-K=1536": {
