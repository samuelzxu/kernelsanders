"""
MXFP4-MM: #104 - Try num_warps=8 for M=64 K=2048 shape.
Current: num_warps=4 with BSM=32 BSN=64 BSK=512, 224 tiles (0.875 waves).
With 8 warps: more parallelism within each tile, better memory latency hiding.
Also try waves_per_eu=2 for more occupancy.
Based on #102 (current best).
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # KEY CHANGE: num_warps=8 waves_per_eu=2 for M=64 K=2048
    "N=7168-K=2048": {
        "M_LEQ_64": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 2, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
    ...
    # Keep MFMA32 for M=256 (confirmed improvement)
    "N=3072-K=1536": {
