"""
MXFP4-MM: Use double-quant for ALL shapes (no unshuffle).
Test if unshuffle is actually saving time vs just re-quantizing B.
With the latest configs, the GEMM might be fast enough to absorb the quant overhead.
"""
import json
import os
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # ALL shapes: double-quant B for scale (no unshuffle)
