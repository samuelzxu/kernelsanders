"""
MXFP4-MM: BSN=32 for K=512/M=32 + reuse B_q (unshuffle for all K).
Inspired by leaderboard submission name: reuse_triton_k512m32_bs32
"""
import json
import os
import triton
...
# KEY CHANGE: BSN=32 for K=512/M=32 shapes (more parallelism)
_CONFIGS = {
    "N=2880-K=512": {
        "M_LEQ_4": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 32, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 2, "waves_per_eu": 3, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        "M_LEQ_32": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 32, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 2, "waves_per_eu": 3, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # "reuse" B_q: unshuffle B_scale for ALL K (avoid double quant even for K=512)
