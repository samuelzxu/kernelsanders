"""
MXFP4-MM: #102 - MFMA 32x32 only for M=256 shape.
#101 showed M=256 improved 0.6µs with MFMA 32x32 but M=64 got 1.6µs worse.
So use MFMA 32 only for M_LEQ_256 tier in K=1536 config.
All other shapes keep MFMA 16.
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # K=2048: Keep MFMA 16 with BSN=64 (confirmed improvement)
    "N=7168-K=2048": {
    ...
    # K=1536: MFMA 16 for M<=64, MFMA 32 for M=256 (-0.6µs in #101)
    "N=3072-K=1536": {
