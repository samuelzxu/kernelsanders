"""
MXFP4-MM: #127 - num_stages=2 for K=7168 M=16 (was 3).
After get_splitk: KSPLIT=7 with 2 K-iters per split.
With 2 K-iters, num_stages=2 is the natural pipeline depth (1:1 match).
num_stages=3 overshoots for 2 iterations (wasted register pressure).
Based on #118.
"""
import json
import os
...
_CONFIGS = {
    ...
    # KEY: num_stages=2 for K=7168 M=16 (was 3)
    "N=2112-K=7168": {
