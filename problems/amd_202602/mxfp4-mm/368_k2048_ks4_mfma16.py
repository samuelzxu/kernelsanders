...
#!POPCORN gpu MI355X
"""
#368: K=2048 KSPLIT=4 mfma16 BSN=256.
448 blocks (vs 224 with KSPLIT=2). More parallelism but more reduction.
Mfma16 might work better with 4 splits than mfma32.
"""
