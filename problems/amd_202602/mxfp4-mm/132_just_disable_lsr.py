"""
MXFP4-MM: #132 - Try JUST disable-lsr alone.
#130 proved DISABLE_LLVM_OPT=1 works (disables ALL opts → 2x slower).
#128-131 with specific flags had no effect. Try single flag.
Also try TRITON_LLVM_OPT_FLAGS as alternative env var name.
"""
import os, shutil
# Try multiple env var names/formats
os.environ['DISABLE_LLVM_OPT'] = 'disable-lsr'
# Try the alternative: LLVM pass flags directly
os.environ['TRITON_LLVM_OPT_FLAGS'] = '-disable-lsr -disable-machine-licm'
# Try AMDGPU-specific
os.environ['AMDGPU_ENABLE_LOOP_STRENGTH_REDUCE'] = '0'
