"""
MXFP4-MM: Inject ALL shape-specific tuned configs + hybrid unshuffle.
"""
import json
import os
...
# All shape-specific configs from the aiter repo + custom K=512 configs
_CONFIGS = {
    "N=2880-K=512": {
...
def _inject_configs():
    ...
    for shape_key, config in _CONFIGS.items():
        ...
        # Always write (overwrite) to ensure our tuned configs are used
