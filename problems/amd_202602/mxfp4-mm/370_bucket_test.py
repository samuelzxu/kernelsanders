...
#!POPCORN gpu MI355X
"""
#370: Test M_LEQ bucket boundaries. What if M=4 uses the M=32 config (BSN=32)?
Currently: M_LEQ_4 uses BSM=8 BSN=16. What if M_LEQ_8 uses BSM=8 BSN=32?
Also: what if we add M_LEQ_16 for K=512 shapes with different config?
"""
...
# Test: M=4 with BSM=8 BSN=32 (previously BSN=16)
# Also try M=4 with BSM=4 (if supported)
_cfgs={"N=2880-K=512":{
"M_LEQ_4":{"BLOCK_SIZE_M":8,"BLOCK_SIZE_N":32,"BLOCK_SIZE_K":512,"GROUP_SIZE_M":1,"NUM_KSPLIT":1,"num_warps":4,"num_stages":1,"waves_per_eu":2,"matrix_instr_nonkdim":16,"cache_modifier":".cg"},
