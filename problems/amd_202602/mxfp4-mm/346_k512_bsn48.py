...
#!POPCORN gpu MI355X
"""
#346: K=512 M=32 BSN=48 — between 32 and 64. N=2880/48=60, N=4096/48 not divisible.
Actually BSN must divide N for the kernel to work. 2880/48=60 ok. 4096/48=85.3 not ok.
Let me try BSN=32 for N=2880 and BSN=64 for N=4096 instead.
Actually, the preshuffle kernel handles non-divisible N with masking. Let me try.
"""
