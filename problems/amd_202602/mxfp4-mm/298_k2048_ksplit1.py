...
#!POPCORN gpu MI355X
"""
#298: K=2048 M=64: try KSPLIT=1 mfma16 BSN=128 (no reduction kernel).
K_packed=1024, BSK=256: 4 K-iters. Grid: 4×56=224 blocks. Good utilization.
Also try K=1536 with cache_modifier=".cg" and waves_per_eu=2.
"""
...
_cfgs = {
    ...
    # K=2048: KSPLIT=1 mfma16 BSN=128. Grid: 4×56=224 blocks. No reduction.
    "N=7168-K=2048": {
        "M_LEQ_64": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
    ...
    # K=1536: same tiles but with .cg cache modifier and waves=2
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 3, "num_warps": 8, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None}
    },
}
