...
#!POPCORN gpu MI355X
"""
#289: Sweep K=1536 M=256 configs. Current: 17.8µs ranked.
Try KSPLIT=6 BSK=128 (more blocks), BSM=64, and KSPLIT=2 BSK=256.
Also try waves_per_eu=2 and stages=3 for K=1536.
"""
...
_cfgs = {
    ...
    # K=1536 M=256: TRY KSPLIT=6 BSK=128 BSN=128
    # K_packed=768, KSPLIT=6: 128 per split, BSK=128: 1 iter
    # Grid: ceil(256/32) x ceil(3072/128) x 6 = 8 x 24 x 6 = 1152 blocks
    # More parallelism but more reduction overhead
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 128, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 6, "num_warps": 4, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None}
    },
}
