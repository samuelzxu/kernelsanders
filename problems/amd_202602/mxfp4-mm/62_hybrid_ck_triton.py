"""
MXFP4-MM: Hybrid CK (tuned shapes) + Triton (untuned shapes).
cu_num=256 confirmed! CK CSV has tuned configs for:
  - (256, 64, 7168, 2048) -> 6.8µs
  - (256, 256, 3072, 1536) -> 6.2µs
Use CK for these, Triton for K=512 and K=7168/M=16.
"""
import json
import os
import triton
...
# Shapes with CK tuned configs (cu_num=256, exact M match)
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use CK for shapes with tuned configs
