"""
MXFP4-MM: #129 - Disable LLVM LSR+LICM with cache clear.
#128 failed because aiter kernels are pre-cached. Must clear Triton cache
to force recompilation with the LLVM flags.
"""
import os, shutil
# Set LLVM optimization flags BEFORE any Triton import
