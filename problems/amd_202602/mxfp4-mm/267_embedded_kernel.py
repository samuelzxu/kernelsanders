...
#!POPCORN gpu MI355X
"""
#267: EMBEDDED preshuffle kernel - bypass aiter wrapper completely.
Calls the Triton JIT kernel directly with hardcoded configs.
Eliminates torch_guard, config lookup, and torch.ops dispatch overhead.
"""
import os, json, sys, torch, triton, triton.language as tl
from task import input_t, output_t
from aiter.ops.triton.utils.core import AITER_TRITON_CONFIGS_PATH
from aiter.ops.triton.utils._triton import arch_info
# Import the actual kernel and quant op
...
# Still inject configs for the kernel's internal lookup
...
# Hardcoded configs per (M_range, N, K) - avoids JSON lookup at runtime
# Key format: (M_leq_threshold, N, K_original) -> config dict
from aiter.ops.triton.gemm.basic.gemm_a16wfp4 import _get_config as _aiter_get_config

# Pre-compute configs for all benchmark shapes
_CONFIG_CACHE = {}
for _m, _n, _k in [(4,2880,512),(16,2112,7168),(32,4096,512),(32,2880,512),(64,7168,2048),(256,3072,1536)]:
    _Kh = _k // 2
    cfg, _ = _aiter_get_config(_m, _n, _Kh, shuffle=True)
    _CONFIG_CACHE[(_m, _n, _k)] = cfg
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use the standard preshuffle path (configs are pre-warmed)
