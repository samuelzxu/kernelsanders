...
#!POPCORN gpu MI355X
"""
#286: Tune K=7168 M=16. Currently 16.3µs with aiter default (KSPLIT=14).
Try: KSPLIT=7 with BSN=128 and KSPLIT=4 with BSN=256.
"""
...
_cfgs = {
    ...
    # K=7168 M=16: TRY custom config instead of aiter default
    # K_packed=3584. KSPLIT=7: 512 per split, BSK=256: 2 iters per block
    # Grid: ceil(16/16) x ceil(2112/128) x 7 = 1 x 17 x 7 = 119 blocks
    # KSPLIT=4: 896 per split, BSK=256: 3.5 iters → not divisible
    # KSPLIT=7: 512/256=2 iters. Good.
    "N=2112-K=7168": {
