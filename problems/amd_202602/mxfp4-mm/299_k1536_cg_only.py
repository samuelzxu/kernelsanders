...
#!POPCORN gpu MI355X
"""
#299: K=1536 M=256: ONLY change cache_modifier from None to ".cg".
All other params identical to #286 best config.
B matrix is 2.25MB, fits in L2. With 288 blocks reading same B,
".cg" (bypass L1, go straight to L2) may reduce L1 thrash.
"""
...
_cfgs = {
    ...
    # K=1536: ONLY change: cache_modifier ".cg" for M_LEQ_256 (was None)
    "N=3072-K=1536": {
