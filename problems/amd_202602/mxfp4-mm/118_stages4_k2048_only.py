"""
MXFP4-MM: #118 - num_stages=4 for K=2048 only.
#117 showed M=64 improved 0.4µs with num_stages=4, but M=16 got slightly worse.
Keep num_stages=4 only for K=2048, revert K=7168 to num_stages=3.
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # K=7168: keep num_stages=3 (num_stages=4 was worse in #117)
    "N=2112-K=7168": {
    ...
    # K=2048: num_stages=4 (improved M=64 by 0.4µs in #117)
    "N=7168-K=2048": {
