...
#!POPCORN gpu MI355X
"""
#291: K=1536 M=256: try stages=3 waves=4 warps=8 (more pipelining).
Same tile sizes as best config, just different scheduling params.
"""
...
_cfgs = {
    ...
    # K=1536 M=256: stages=3 waves=4 warps=8 (more pipelining than stages=2)
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 8, "NUM_KSPLIT": 3, "num_warps": 8, "num_stages": 3, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None}
    },
}
