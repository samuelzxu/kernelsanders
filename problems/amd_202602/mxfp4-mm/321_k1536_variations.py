...
#!POPCORN gpu MI355X
"""
#321: K=1536 M=256: KSPLIT=2 mfma32 BSN=128 (more blocks: 8×24×2=384).
Previous best: BSN=256 KSPLIT=2 mfma32 = 16.5µs (8×12×2=192 blocks).
More blocks might improve occupancy.
"""
...
_cfgs = {
    ...
    # K=1536: KSPLIT=2 mfma32 BSN=128 (384 blocks)
    "N=3072-K=1536": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 2, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 32, "cache_modifier": ".cg"},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "NUM_KSPLIT": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None}
    },
}
