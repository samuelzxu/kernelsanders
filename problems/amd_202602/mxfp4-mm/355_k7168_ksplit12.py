...
#!POPCORN gpu MI355X
"""
#355: K=7168 KSPLIT=12. K_packed=3584, 3584/12=298.7 — not clean.
get_splitk should adjust. Also try KSPLIT=10 and KSPLIT=2.
Let me try KSPLIT=2 BSN=128 — fewer splits, bigger blocks.
K_packed=3584, KSPLIT=2: 1792 per split, BSK=256: 7 iters.
Grid: 1×17×2 = 34 blocks. Very few but less reduction overhead.
"""
...
"N=2112-K=7168":{
"M_LEQ_16":{"BLOCK_SIZE_M":16,"BLOCK_SIZE_N":128,"BLOCK_SIZE_K":256,"GROUP_SIZE_M":1,"NUM_KSPLIT":2,"num_warps":4,"num_stages":2,"waves_per_eu":4,"matrix_instr_nonkdim":16,"cache_modifier":".cg"},
