"""
MXFP4-MM: Try different configs for K=2048/M=64 (our worst shape at 1.70x ref).
Experiment: BSM=64, BSN=128, BSK=512, KSPLIT=1 with 3 stages.
The idea: M=64 exactly fills a BSM=64 tile, BSN=128 gives good N coverage.
"""
import json
import os
import triton
...
_CONFIGS = {
    ...
    # EXPERIMENT: M=64, N=7168, K=2048 - try BSM=64, BSN=128, BSK=512
    "N=7168-K=2048": {
        "M_LEQ_64": {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "NUM_KSPLIT": 1, "num_warps": 4, "num_stages": 3, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg"},
