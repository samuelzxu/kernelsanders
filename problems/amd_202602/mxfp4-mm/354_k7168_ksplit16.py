...
#!POPCORN gpu MI355X
"""
#354: K=7168 M=16: try KSPLIT=16 BSN=128 (272 blocks) and KSPLIT=14 BSN=64 (462 blocks).
Also: K=2048 M=64 try BSN=128 mfma32 KSPLIT=2 (no—mfma32+BSN=128 was catastrophic).
Instead try K=2048 BSN=128 mfma16 KSPLIT=4.
"""
...
"N=2112-K=7168":{
"M_LEQ_16":{"BLOCK_SIZE_M":16,"BLOCK_SIZE_N":128,"BLOCK_SIZE_K":256,"GROUP_SIZE_M":1,"NUM_KSPLIT":16,"num_warps":4,"num_stages":2,"waves_per_eu":4,"matrix_instr_nonkdim":16,"cache_modifier":".cg"},
