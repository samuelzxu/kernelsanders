"""
MLA decode - NO torch.compile for GEMM + precomputed metadata.

Test: does torch.compile add dispatch overhead for small configs?
If the raw ops (baddbmm + softmax + bmm) are faster without compile,
we save ~2-3µs on small configs.
"""
