"""
MLA decode — hybrid: torch.compile GEMM for small configs + fp8 assembly for large.
MXFP4 fused Triton kernel kept for future optimization (V from MXFP4).
"""
import os
...
# ─── MXFP4 fused Triton kernel (split nope+rope) ───
@triton.jit
def _mxfp4_stage1(
    ...
    # Q nope: (32, 512) bf16 → quantize to MXFP4
    ...
    # Q rope: (32, 64) bf16 → quantize to MXFP4
...
def _run_mxfp4_fused(q, kv_data, kv_indptr, bs):
    """MXFP4 fused Triton kernel path."""
