"""
MLA decode - nks=64 for kv>1024 (NEVER TESTED with kvg=32).

Previous nks tests used kvg=64. With kvg=32, the math changes:
- nks=32/kvg=32: 256 tokens/CTA, 8 groups/CTA (current)
- nks=64/kvg=32: 128 tokens/CTA, 4 groups/CTA
  - bs=32: 2048 CTAs = 8 waves (vs 4 waves with nks=32)
  - bs=64: 4096 CTAs = 16 waves (vs 8 waves)
  - bs=256: 16384 CTAs = 64 waves (vs 32 waves)

More waves could help when GPU is in lower-frequency state
(explaining the high variance in kv>1024 configs).

Reduce buffer doubles: bs=256: lg=268MB (vs 134MB with nks=32).
But 64 waves should provide better latency hiding.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if kv_seq_len <= 1024:
        ...
        # nks=64: double the waves, 4 groups/CTA with kvg=32
        kvg, nks = 32, 64
