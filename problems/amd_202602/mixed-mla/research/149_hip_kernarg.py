...
GEMM (baddbmm) for bs<=4 (all kv) or bs<=32/kv<=1024.
a16w8/a8w8 assembly for larger cases.

Attempt 149: HIP_FORCE_DEV_KERNARG=1 to reduce kernel launch overhead.
This puts HIP kernel arguments directly in device memory (saves 2-3µs/launch).
"""
