...
_kv_view_cache: dict[int, torch.Tensor] = {}
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Reshape kv_buffer to 4D for aiter (cached view)
    if total_kv_len not in _kv_view_cache:
        _kv_view_cache[total_kv_len] = kv_buffer_fp8.view(
            total_kv_len, PAGE_SIZE, NUM_KV_HEADS, QK_HEAD_DIM
        )
    kv_buffer_4d = _kv_view_cache[total_kv_len]
