"""
MLA decode - combined best: self-alloc compiled GEMM + kvg=32 + nks=16.

Combines the improvements from:
- 163: per-shape compiled GEMM
- 168: allocation inside compiled function (bs=4/kv=8192: 38.7µs)
- 166: nks=16 for kv>1024 (equivalent to nks=32, smaller reduce buffer)
- 160: kvg=32 for kv>1024 (better than kvg=64)
- 168: kvg=32 for kv<=1024 (neutral in isolation)
"""
