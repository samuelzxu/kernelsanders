"""
MLA decode - Inductor optimization options for torch.compile.

Try specific Inductor options:
- coordinate_descent_tuning=True: enables additional kernel autotuning
- epilogue_fusion=True: fuses epilogue ops with GEMM kernels
- aggressive_fusion=True: more aggressive op fusion
"""
...
_compiled_gemm_short = torch.compile(_gemm_attn_self_alloc, options=_compile_opts)
_compiled_gemm_long = torch.compile(_gemm_attn_self_alloc, options=_compile_opts)
