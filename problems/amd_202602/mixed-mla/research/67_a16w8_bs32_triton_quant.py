...
a16w8 for bs<=32 (no quant needed), a8w8+Triton quant for bs>32.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if bs <= 32:
        # a16w8: bf16 Q + fp8 KV (NO quantization overhead)
        ...
        # a8w8: fp8 Q + fp8 KV (Triton quant, qSeqLen=1 kernel)
        kv_buffer, kv_scale = kv_data["fp8"]
