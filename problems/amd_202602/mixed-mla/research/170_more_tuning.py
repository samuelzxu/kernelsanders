"""
MLA decode - increased TunableOp tuning budget.

Same as 168 but with more tuning iterations to find better GEMM kernels
(including SplitK variants for small M=16 GEMM).

PYTORCH_TUNABLEOP_MAX_TUNING_ITERATIONS=100: tries more algorithm variants
PYTORCH_TUNABLEOP_MAX_WARMUP_DURATION_MS=50: adequate warmup per candidate
"""
