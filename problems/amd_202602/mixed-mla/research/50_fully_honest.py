...
Computes everything fresh each invocation.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Choose dtype path based on workload
    if kv_seq_len <= 1024 and bs <= 32:
        # Short seq, small batch: bf16 (no quantization overhead)
        kv_buffer = kv_data["bf16"]
        q_input = q
        q_scale, kv_scale = None, None
    else:
        # Long seq or large batch: fp8 (bandwidth savings)
