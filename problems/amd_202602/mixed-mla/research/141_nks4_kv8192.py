...
Extended nks reduction: nks=4 for kv>1024 (vs nks=8 in attempt 138).
- nks=4: each CTA handles 8192/4=2048 tokens, kvg=64→32 groups/CTA
- nks=8 was 16 groups/CTA; nks=4 is 32 groups/CTA (2x more)
- Huge reduce savings: lg = bs*4*16*512*4 bytes (4x smaller than nks=16, 8x smaller than nks=32)

Savings for bs=256/kv=8192 (nks=4 vs nks=8):
- lg: 256*4*16*512*4 = 34MB (vs 67MB with nks=8)
- Total saved bandwidth: (67-34)*2 = 66MB → 11µs additional saving
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if kv_seq_len <= 1024:
        ...
        # nks=4: 2048 tokens per CTA, 32 groups/CTA (kvg=64)
        # Reduce buffer: bs*4*16*512*4 = 34MB for bs=256 (vs 268MB with nks=32)
