"""
MLA decode kernel - honest, no persistent state.
Persistent mode with inference_mode for faster tensor ops.
bf16 for short seq, a8w8 for long seq.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    use_bf16 = (bs <= 32 and kv_seq_len <= 1024)
    if use_bf16:
        kv_buffer = kv_data["bf16"]
        q_input, q_scale, kv_scale = q, None, None
        qd, kvd = BF16, BF16
    else:
    ...
    # Metadata - computed fresh each call
