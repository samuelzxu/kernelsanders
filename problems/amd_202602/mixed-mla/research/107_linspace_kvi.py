...
def custom_kernel(data: input_t) -> output_t:
    ...
    if kv_seq_len <= 1024:
        ...
        kvg = 16
        nks = 8  # fewer splits for short seq: less metadata + faster reduce
    else:
    ...
    klp = qo_indptr[1:bs+1]  # reuse existing tensor, kernel ignores klp for PAGE_SIZE=1
    kvi = torch.linspace(0, n - 1, n, dtype=torch.int32, device="cuda")
