"""
MLA decode - minimize within-invocation overhead.
No persistent state. Assembly kernels only.
Optimizations: avoid CPU-side function calls, combine allocations.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Always a8w8 for correctness match with reference
