...
# Pre-compute assembly configs (including bs=4/kv=8192 which is faster with asm)
_precompute_config(4, 8192, 32, FP8_DTYPE, FP8_DTYPE)
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Tiny configs: torch.compile GEMM (fastest for kv≤1024 with small bs)
    if (bs <= 4 and kv_seq_len <= 1024) or (bs <= 32 and kv_seq_len <= 1024):
