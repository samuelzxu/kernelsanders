"""
MLA decode - honest, fast_mode metadata.
a16w8 for kv<=1024, a8w8+Triton quant for kv>1024.
fast_mode=True for smaller/faster metadata.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # fast_mode=True: smaller buffers, faster metadata GPU kernel
    info = get_mla_metadata_info_v1(
        bs, 1, NH, qd, kvd, is_sparse=False, fast_mode=True,
