"""
v150: Extend cktile to E=257 shapes (skip expert<=33 restriction).
Hypothesis: cktile BF16 path (no quant) may be faster for E=257 moderate-density shapes.
Tests cktile for E=257 bs=128 and bs=512 with sk=1 (not sk=2).
"""
import os, sys, stat
...
def _patched(token, model_dim, inter_dim, expert, topk,
    ...
    if inter_dim > 1024:
        ...
        # CHANGED: removed expert<=33 restriction
        # Try cktile sk=1 for ALL experts with moderate density
        use_cktile = True
        sk = 1
