"""
v98: Pre-allocate sorting buffers + force non-temporal loads for ALL shapes.
Default: use_nt=True only when tok_per_expert < 64.
For E=33 bs=512: tok_per_expert=139, so NT is disabled.
But MoE weights are accessed once per call and don't benefit from caching.
NT loads free L2 cache for activation data reuse between stage1 and stage2.
"""
import os
