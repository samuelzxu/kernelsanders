"""
v111: Use regular moe_sorting_fwd instead of opus sorting.
v103 uses opus sorting (moe_sorting_opus_fwd) which was found beneficial.
This tests whether regular sorting is better or worse on current MI355X runner.
Hypothesis: opus sorting may not be faster on all runner configs.
All other parameters same as v103.
"""
import os
...
# Force regular sorting (not opus) to compare
_sort_fwd = aiter.moe_sorting_fwd
