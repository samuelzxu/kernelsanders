"""
v183: Direct kernel dispatch - bypass fused_moe Python overhead.
Call sorting + ASM/CK kernels directly with pre-allocated buffers.
Eliminates: fused_moe wrapper, moe_sorting alloc, metadata lookup overhead.
"""
import os, sys, stat
...
# Monkeypatch moe_sorting to use cached buffers
_sorting_bufs = {}
...
def _cached_moe_sorting(topk_ids, topk_weights, num_experts, model_dim,
    ...
    key = (M, num_experts, model_dim, block_size)
    ...
    _sort_fwd(topk_ids, topk_weights, sorted_ids, sorted_weights,
              ...
              int(block_size), expert_mask, num_local_tokens, dispatch_policy)
    return sorted_ids, sorted_weights, sorted_expert_ids, num_valid_ids, moe_buf

# Replace AITER's moe_sorting with our cached version
_fm.moe_sorting = _cached_moe_sorting

# Standard patching for dispatch
