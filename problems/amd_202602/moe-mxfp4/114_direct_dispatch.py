"""
v114: Test AMD_DIRECT_DISPATCH=1 for reduced kernel launch overhead.
Direct dispatch bypasses the HIP runtime command queue and dispatches
kernels directly to the GPU, reducing latency per kernel launch.
Combined with HIP_FORCE_DEV_KERNARG=1 for device-side kernel args.
