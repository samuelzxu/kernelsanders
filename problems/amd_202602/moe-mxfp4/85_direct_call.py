"""
v85: Direct call to moe_sorting + fused_moe_2stages, bypassing fused_moe/fused_moe_.
Eliminates 2 function calls in the hot path.
Combined with v78's cktile optimization.
"""
import os
