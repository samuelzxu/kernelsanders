"""
v76: Hybrid ksplit - use cktile for small batches, keep CSV-tuned CK for large.
Override get_2stage_cfgs to swap stage1/stage2 callables for ksplit shapes.
No AITER_BYPASS_TUNE_CONFIG needed.
"""
import os
