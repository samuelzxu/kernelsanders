"""
v99: Pre-allocate sorting buffers + use Opus sorting implementation.
AITER supports two sorting implementations:
- Default: aiter.moe_sorting_fwd
- Opus: aiter.moe_sorting_opus_fwd
