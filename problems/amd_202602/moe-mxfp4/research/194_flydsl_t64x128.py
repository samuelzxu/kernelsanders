"""
v194: Test FlyDSL t64x128x128_atomic and t64x128x256_reduce for shape 7.
"""
import os, sys, stat
...
def _inject_flydsl():
    ...
    try:
        ...
        # Test t64x128x128_atomic (smaller tiles, might be faster for small expert count)
        _fm.cfg_2stages[key] = {
            ...
            "kernelName2": "flydsl_moe2_afp4_wfp4_bf16_t64x128x128_atomic",
        }
    except Exception: pass
