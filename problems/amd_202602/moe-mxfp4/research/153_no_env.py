"""
v153: Zero JIT + NO environment variable overrides.
Tests whether HIP_FORCE_DEV_KERNARG, GPU_MAX_HW_QUEUES, AITER_USE_NT
actually help or hurt. Let AITER use its own heuristics.
"""
import os, sys, stat
...
# NO env var overrides — let AITER use its defaults
