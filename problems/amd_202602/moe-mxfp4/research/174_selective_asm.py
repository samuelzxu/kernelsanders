"""
v174: Selective ASM 1-stage. Only use ASM for E<=33 with inter_dim<=1024.
For E=257 shapes, let CK 2-stage handle (its GEMM is more efficient for
many-expert configurations even with quant overhead).
"""
import os, sys, stat
...
def _patched(token, model_dim, inter_dim, expert, topk,
    ...
    # For E=257, CK 2-stage is better (efficient GEMM tiles for many experts)
    ...
    # Default CK 2-stage for everything else (E=257 dense, d_expert>1024)
    return md
