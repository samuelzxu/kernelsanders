"""
v119: Remove HIP_FORCE_DEV_KERNARG=1 to test if it helps or hurts.
This env var was set early (v65) and never tested without.
On MI355X, the default kernel arg handling might be better.
Keep GPU_MAX_HW_QUEUES=2 and AITER_USE_NT=1.
"""
import os
