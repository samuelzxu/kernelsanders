"""
v103: v98 base + opus sorting. Reverts v100's bad E=257 bs=512 cktile extension.
v100 showed cktile for E=257 bs=512 (tok/exp=15.9) is 16% SLOWER than default CK.
This version keeps the proven v98 cktile conditions and adds opus sorting.
"""
import os
