"""
v92: Probe if flydsl is available on the runner.
If yes, use flydsl stage2 with bf16 activations + fp4 weights
for dense shapes. This eliminates the intermediate requant step.
"""
import os
import sys
...
print(f"[PROBE] flydsl available: {_HAS_FLYDSL}", file=sys.stderr)
