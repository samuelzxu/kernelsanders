"""
Bypass fused_moe_ custom op dispatch by calling fused_moe_2stages directly.
This skips the torch_compile_guard wrapper overhead (~50-100µs per call).
"""
import torch
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Get tuned config (cached via lru_cache)
    ...
    # Call 2-stage directly (bypasses fused_moe_ custom op wrapper)
    fused_moe_2stages(
        hidden_states, w1, w2,
