"""
Direct 2-stage with smart use_non_temporal_load:
- True when tokens_per_expert < 64 (sparse, NT helps avoid cache pollution)
- False when tokens_per_expert >= 64 (dense, temporal loads help cache reuse)
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Smart NT: use non-temporal loads only for sparse patterns
    use_nt = (M * topk // E) < 64
