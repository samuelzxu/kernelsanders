"""
v195: Test FlyDSL t32x256x256_reduce for shape 7. Smaller M tile might
give better parallelism for E=33 with ~139 tokens/expert.
"""
import os, sys, stat
...
def _inject_flydsl():
    ...
    try:
        ...
        # t32 tile with block_m=32 for better parallelism
        _fm.cfg_2stages[key] = {
            "block_m": 32, "ksplit": 0, "run_1stage": 0,
