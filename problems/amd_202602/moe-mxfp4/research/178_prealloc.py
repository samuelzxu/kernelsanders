"""
v178: v175 + pre-allocated intermediate buffers.
The fused_moe pipeline allocates a2 (intermediate), quant buffers, etc. every call.
Pre-allocating these eliminates Python malloc/free overhead.
"""
import os, sys, stat
...
# Pre-allocate sorting buffers (same as before)
_sorting_bufs = {}
