"""
v198: Test ksplit=2 for CK 2-stage shape 7 (d=2048).
L2 cache is cleared every iteration, making this memory-bound.
ksplit=2 halves K per workgroup, reducing working set and improving BW utilization.
Also test for cktile shapes which currently use ksplit via our override.
"""
import os, sys, stat
...
os.environ['AITER_KSPLIT'] = '2'  # Force ksplit=2 for all CK 2-stage shapes
...
def _inject_flydsl():
    ...
    try:
        ...
        _fm.cfg_2stages[key] = {
            "block_m": 64, "ksplit": 2, "run_1stage": 0,
