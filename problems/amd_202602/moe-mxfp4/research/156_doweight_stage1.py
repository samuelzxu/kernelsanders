"""
v156: Test doweight_stage1=True — apply routing weights in stage 1 instead of stage 2.
This uses a different CK kernel variant (MulRoutedWeight1 for stage 1).
May be faster by reducing stage 2 work.
"""
import os, sys, stat
...
from aiter.fused_moe import (fused_moe_2stages, get_inter_dim, get_padded_M, get_2stage_cfgs,
...
def custom_kernel(data: input_t) -> output_t:
    ...
    fused_moe_2stages(hidden_states, w1, w2, topk, sorted_ids, sorted_weights,
                      ...
                      doweight_stage1=True,  # <-- KEY CHANGE
