"""
v83: PyTorch memory allocator tuning + v78 optimizations.
PYTORCH_HIP_ALLOC_CONF can tune the caching allocator behavior.
expandable_segments:True reduces fragmentation overhead.
"""
import os
