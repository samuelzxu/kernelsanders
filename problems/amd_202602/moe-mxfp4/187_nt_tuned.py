"""
v187: Per-shape non-temporal load tuning.
AITER_USE_NT=1 enables NT loads globally, but NT is only beneficial for
decode-like shapes (low tokens_per_expert). For dense shapes (high tokens),
regular loads may be better due to L2 cache utilization.
Test: disable AITER_USE_NT and let the heuristic decide per-shape.
"""
import os, sys, stat
...
# NOTE: NOT setting AITER_USE_NT — let the heuristic decide per-shape
