"""
v179: v175 + bypass tuned CSV config. The DSv3 CSV was tuned for different
batch sizes. AITER_BYPASS_TUNE_CONFIG=1 forces heuristic kernel selection
which might pick better configs for our exact shapes.
"""
import os, sys, stat
...
os.environ['AITER_BYPASS_TUNE_CONFIG'] = '1'  # Bypass CSV, use heuristic
