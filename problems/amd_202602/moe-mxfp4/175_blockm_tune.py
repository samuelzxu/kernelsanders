"""
v175: Tune block_m for CK 2-stage shapes. Force block_m=64 for the large
d_expert=2048 shape (was 128). Smaller block_m = more blocks per expert =
better load balancing across CUs.
"""
import os, sys, stat
...
def _patched(token, model_dim, inter_dim, expert, topk,
    ...
    # ASM 1-stage for E<=33 with inter_dim<=1024
    ...
    # CK 2-stage: tune block_m for specific shapes
    # For dense shapes with inter_dim > 1024, override block_m=64
    # (default heuristic picks 128 but 64 may give better CU load balancing)
