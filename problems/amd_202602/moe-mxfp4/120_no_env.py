"""
v120: No custom env vars at all. Tests whether HIP_FORCE_DEV_KERNARG=1,
GPU_MAX_HW_QUEUES=2, and AITER_USE_NT=1 are net positive or neutral.
Pure algorithm optimization: cktile + opus sorting + pre-allocated buffers.
"""
import torch
import functools
import aiter
