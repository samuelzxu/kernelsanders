"""
v100: Combined v98 + Opus sorting + cktile for E=257 bs=512.
- All v98: AITER_USE_NT=1, pre-alloc sorting, cktile for sparse shapes
- Opus sorting: moe_sorting_opus_fwd if available (faster alternative)
- NEW: cktile sk=1 for E=257 bs=512 (inter_dim<=256, tok/exp~18)
"""
import os
...
def _patched(token, model_dim, inter_dim, expert, topk,
    ...
    if inter_dim > 1024:
        ...
        use_cktile = True
        sk = 2
    elif tokens_per_expert < 20 and inter_dim <= 256:
        # E=257 bs=512: tok/exp~18, inter_dim=256 - extend cktile coverage
        use_cktile = True
        sk = 1
