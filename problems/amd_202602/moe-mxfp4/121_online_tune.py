"""
v121: Enable AITER_ONLINE_TUNE=1 for runtime auto-tuning.
This env var enables runtime kernel configuration tuning that may find
better configs than the static heuristics for our specific shapes.
