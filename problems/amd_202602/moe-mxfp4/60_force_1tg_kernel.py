"""
v60: Force 1-stage with 1tg_ps_32x512 kernel for ALL shapes.
v59 showed 2tg_ps_32x256 crashes on E=33 d=512.
The 1tg_ps (1 threadgroup, preshuffle) variant is safer.
...
# Force 1-stage for ALL shapes with specific kernel name
