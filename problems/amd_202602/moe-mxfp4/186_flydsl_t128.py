"""
v186: Test FlyDSL t128x256x256_reduce for shape 7 (d=2048).
Also test atomic mode. Compare different FlyDSL tile sizes.
"""
import os, sys, stat
...
def _inject_flydsl():
    ...
    try:
        ...
        # Shape 7: E=33, d=2048, token=512 — try t128 tile with block_m=128
        key = (256, 512, 7168, 2048, 33, 9,
               "ActivationType.Silu", "torch.bfloat16",
               "torch.float4_e2m1fn_x2", "torch.float4_e2m1fn_x2",
               "QuantType.per_1x32", 1, 0)
        _fm.cfg_2stages[key] = {
            "block_m": 128, "ksplit": 0, "run_1stage": 0,
