"""
v89: Try dispatch_policy=2 (multi-phase sorting) for E=33 shapes.
v85 uses dispatch_policy=0 (auto). For E=33 with 33 experts,
multi-phase sorting may be faster because each phase processes
fewer experts in parallel.

Also keeps all v85 optimizations (cktile, env vars, direct call).
"""
import os
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use dispatch_policy=2 (multi-phase) for E=33, 0 (auto) for E=257
    dp = 2 if E <= 33 else 0
